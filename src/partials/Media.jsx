...
import c16 from '../images/c16.jpeg';
import c17 from '../images/c17.jpeg';
import c18 from '../images/c18.jpeg';
  ...
  return (
    <section id="media">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        {/* Hero content */}
          {/* Section header */}
        <div className="relative pt-10 pb-10 md:pt-35 md:pb-16">
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h2 className="h2 mb-4">Media Gallery</h2>
              ...
              <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <img src={c1} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c2} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c3} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c4} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c5} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c6} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c7} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c8} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c9} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c10} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c11} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c12} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c13} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c14} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c15} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c16} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c17} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={c18} className="d-block w-[100] max-h-[500px]" alt="..." />
                  </div>
                </div>
